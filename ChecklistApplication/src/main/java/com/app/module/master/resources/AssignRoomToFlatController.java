...
public class AssignRoomToFlatController {
	...
	@GetMapping(value = "/getRoomByFlatId/{flatId}")
	public ResponseEntity<Object> getRoomByFlatId(@PathVariable("flatId") Long flatId) throws CheckListAppException {
		ResponseBean responseBean = assignRoomToFlatService.getRoomByFlatId(flatId);
		return new ResponseEntity<Object>(responseBean, HttpStatus.OK);
	}
